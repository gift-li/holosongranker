    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('singer', models.ManyToManyField(through='datas.Singer_Song', to='datas.vtuber')),
            ],
            options={
                'verbose_name': 'song',
        ...
        migrations.AddField(
            model_name='singer_song',
            name='singer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='datas.vtuber'),
        ),
        migrations.AddField(
            model_name='singer_song',
            name='song',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='datas.song'),
        ),
        migrations.CreateModel(
            name='Group',
            fields=[
